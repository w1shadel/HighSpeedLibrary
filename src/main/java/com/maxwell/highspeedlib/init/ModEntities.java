...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, HighSpeedLib.MODID);
    public static final DeferredHolder<EntityType<?>, EntityType<ThrownCoinEntity>> TCOIN = ENTITIES.register("thr_coin",
